...
use App\Http\Controllers\AdminControllermettings;
use App\Http\Controllers\ClientMeetingController;
use App\Http\Controllers\MatchmakerEarningsController;
...
Route::middleware('auth:api')->group(function () {
    Route::get('/messages/support', 'MessageController@getSupportMessages');
});
...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::post('/client/meetings/{meeting}/review', [ClientMeetingController::class, 'reviewMeeting']);
    Route::get('/client/earnings', [ClientMeetingController::class, 'getEarnings']);
    Route::post('/client/request-withdrawal', [ClientMeetingController::class, 'requestWithdrawal']);
    });
});
...
Route::middleware(['auth:api'])->group(function () {
    Route::prefix('matchmaker')->group(function () {
    Route::get('/matchmaker/earnings', [MatchmakerEarningsController::class, 'getEarnings']);
    Route::post('/matchmaker/request-withdrawal', [MatchmakerEarningsController::class, 'requestWithdrawal']);
    });
});

// Admin routes
Route::middleware('auth:api')->prefix('admin')->group(function () {
    Route::get('withdrawals', [AdminControllermettings::class, 'getWithdrawals']);
    Route::get('complaints', [AdminControllermettings::class, 'getComplaints']);
    Route::post('withdrawals/{withdrawal}/approve', [AdminControllermettings::class, 'approveWithdrawal']);
    Route::post('withdrawals/{withdrawal}/reject', [AdminControllermettings::class, 'rejectWithdrawal']);
    Route::post('complaints/{review}/resolve', [AdminControllermettings::class, 'resolveComplaint']);
    Route::post('meetings/{meeting}/refund', [AdminControllermettings::class, 'refundMeeting']);
