    ...
    async getClients() {
      ...
      try {
        ...
        if (data.success) {
          ...
          console.log('Clients:', this.clients); // Debugging: Verify clients data
        } else {
    ...
    async getUpcomingMeetings() {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          console.log('Matchmaker Meetings:', this.matchmakerMeetings); // Debugging
          console.log('Client Meetings:', this.clientMeetings); // Debugging
        } else {
          console.error('Failed to fetch upcoming meetings:', response.data.message);
          alert('Failed to fetch upcoming meetings.');
        }
      } catch (error) {
