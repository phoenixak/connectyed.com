  ...
  <div class="container mx-auto p-4">
    ...
    <div v-if="isAuthenticated">
      ...
      <div v-if="currentTab === 'schedule'">
        ...
        <div v-if="selectedTimeSlot" class="mb-4">
          <div class="bg-gray-50 p-4 rounded-lg shadow">
            <label class="block text-gray-700 font-bold mb-2" for="discountCode">
    ...
    <div class="fixed bottom-4 right-4 z-50">
      <button
        ...
        class="px-6 py-3 bg-blue-500 text-white rounded-full hover:bg-blue-600 shadow-lg transition duration-200 flex items-center space-x-2"
      >
...
import Support from '@/components/Support.vue'; // Import the Support component
...
export default {
  ...
  components: {
    Messaging,
    Support, // Register the Support component
  },
  data() {
    return {
      showSupport: false, // Manage the visibility of the Support component
  ...
  methods: {
    ...
    /**
     * **Updated proceedToPayment method to include discount code.**
    ...
    async proceedToPayment() {
      ...
      try {
        ...
        console.log('Discount Code:', this.discountCode.trim() || 'None');
        ...
        const response = await axios.post(
          '/api/google/create-meeting',
          {
            ...
            duration: duration,
            discount_code: this.discountCode.trim() || null, // **Added discount code**
          },
          {
            headers: {
              Authorization: `Bearer ${this.authorization.token}`,
        ...
        if (response.data.success) {
          ...
          alert('Meeting Created Successfully...Check your inbox after making payment! 🛒 Redirecting to payment...');
