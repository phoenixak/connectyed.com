		...
		<div class="header__bottom">
			<div class="container">
              ...
              <button class="btn" type="button" v-if="currentRouteName!='register'">
                <router-link :to="{name:'register'}" class="bg-connectyed-button-light text-connectyed-button-dark hover:bg-connectyed-button-hover-light hover:text-connectyed-button-light py-4 px-5">Register for free</router-link>
              </button>                          
              <button class="btn"type="button" v-else-if="currentRouteName=='register' || !user.user">
